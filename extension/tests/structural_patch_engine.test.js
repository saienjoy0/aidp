...
const regions = [
  ...
  { region_id: 'region_2', start: 3, end: 7, duration: 4, text: 'B B', speaker: '2', keep: '保留', voice_type: '说话', quality: '无问题', round_id: 2 },
...
const patch = {
  ...
  operations: [
    ...
    },
    {
      ...
      region: { start: 8, end: 9, text: 'NEW', speaker: '3', keep: '保留', voice_type: '说话' },
